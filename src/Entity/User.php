...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Questions::class, mappedBy="user_id")
     */
    private $questions;

    /**
     * @ORM\OneToMany(targetEntity=Resultats::class, mappedBy="user_id")
     */
    private $resultats;
    ...
    public function removeResultat(Resultats $resultat): self
    {
        if ($this->resultats->removeElement($resultat)) {
            // set the owning side to null (unless already changed)
            if ($resultat->getUserId() === $this) {
                $resultat->setUserId(null);
            }
        }
